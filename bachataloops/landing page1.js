...
lib.ssMetadata = [
		{name:"landing page1_atlas_1", frames: [[1026,1204,760,360],[0,0,964,875],[966,0,707,549],[1026,551,569,651],[0,877,1024,640]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(276.05,627.4,0.9704,0.9704);

	this.instance_1 = new lib.Interpolación3("synched",0);
	this.instance_1.setTransform(904.2,774.55,0.8844,0.8844,0,0,0,234.3,302.6);

	this.instance_2 = new lib.Símbolo2();
	this.instance_2.setTransform(339.2,216.3,1,1,0,0,0,450.2,213.3);

	this.instance_3 = new lib.Símbolo3();
	this.instance_3.setTransform(636,110,1,1,0,0,0,512,320);

	this.instance_4 = new lib.Símbolo5();
	this.instance_4.setTransform(326.95,477.2,1,1,0,0,0,353.5,274.5);
	this.instance_4.shadow = new cjs.Shadow("rgba(148,0,230,1)",38,-60,131);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/landing page1_atlas_1.png?1700104596796", id:"landing page1_atlas_1"}
	],
	preloads: []
};
