...
lib.ssMetadata = [
		{name:"landing page4_atlas_1", frames: [[0,877,881,133],[966,0,604,640],[0,0,964,875],[966,642,569,651],[0,1012,628,131]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(159,685);

	this.instance_1 = new lib.Mapadebits15();
	this.instance_1.setTransform(-792,1181);

	this.instance_2 = new lib.Símbolo10();
	this.instance_2.setTransform(965.9,288.45,0.743,0.743,0,0,0,482,437.5);

	this.instance_3 = new lib.Símbolo15();
	this.instance_3.setTransform(297.65,335.55,1,1,0,0,0,284.5,325.5);

	this.instance_4 = new lib.Símbolo4();
	this.instance_4.setTransform(480.1,600.1,1.1842,1.1842,0,0,0,202.6,42.3);
...
p.nominalBounds = new cjs.Rectangle(-317,363.4,1988,1329.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits15.png?1700104263242", id:"Mapadebits15"},
		{src:"images/landing page4_atlas_1.png?1700104263200", id:"landing page4_atlas_1"}
	],
	preloads: []
};
