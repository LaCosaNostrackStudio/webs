...
lib.ssMetadata = [
		{name:"landing page4_atlas_1", frames: [[0,877,881,133],[0,1248,456,101],[0,1145,755,101],[966,0,604,640],[0,0,964,875],[966,642,569,651],[0,1012,628,131],[458,1248,194,154]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2463,512);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(2,1,1).p("As8AAIZ5AA");
	this.shape.setTransform(82.925,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo4, new cjs.Rectangle(-1,-1,167.9,2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-310,325.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},41,cjs.Ease.get(1)).to({x:284.5},59,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-594.5,0,1163.5,651);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://pay.hotmart.com/B88868944H?checkoutMode=10", "_blank");
		}
	}
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(884,437.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:163.75},60,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-318.2,0,1684.2,875);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo7, new cjs.Rectangle(0,0,229.7,50.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(43,49,0.9016,0.9016);
...
// stage content:
(lib.landingpage4 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(138.8,132.5,1.0931,1.0931,0,0,0,128.3,128.3);

	this.instance_3 = new lib.Mapadebits7();
	this.instance_3.setTransform(159,685);

	this.instance_4 = new lib.Mapadebits15();
	this.instance_4.setTransform(-792,1181);

	this.instance_5 = new lib.Símbolo10();
	this.instance_5.setTransform(965.9,334.95,0.743,0.743,0,0,0,482,437.5);

	this.instance_6 = new lib.Símbolo15();
	this.instance_6.setTransform(297.65,382.05,1,1,0,0,0,284.5,325.5);

	this.instance_7 = new lib.Símbolo4_1();
	this.instance_7.setTransform(480.1,600.1,1.1842,1.1842,0,0,0,202.6,42.3);
...
p.nominalBounds = new cjs.Rectangle(-317,409.9,1988,1283.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits15.png?1701915717732", id:"Mapadebits15"},
		{src:"images/landing page4_atlas_1.png?1701915717690", id:"landing page4_atlas_1"}
	],
	preloads: []
};
