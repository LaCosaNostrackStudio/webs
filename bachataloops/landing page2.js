...
lib.ssMetadata = [
		{name:"landing page2_atlas_1", frames: [[0,1131,881,133],[836,1269,1088,86],[966,0,889,625],[0,877,834,252],[0,1266,834,135],[966,627,604,640],[0,0,964,875]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},74,cjs.Ease.get(1)).to({x:482},59,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1588,875);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:206.4},79,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1026.7,93.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(23.05,695.4,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_6();
	this.instance_1.setTransform(23.05,350.85,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_5();
	this.instance_2.setTransform(23.05,213.95,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_4();
	this.instance_3.setTransform(23.05,133.05,0.5,0.5);

	this.instance_4 = new lib.Símbolo4();
	this.instance_4.setTransform(480.1,61.1,1.1842,1.1842,0,0,0,202.6,42.3);

	this.instance_5 = new lib.Símbolo10();
	this.instance_5.setTransform(710,430.5,1,1,0,0,0,482,437.5);
...
p.nominalBounds = new cjs.Rectangle(498.1,393,1317.9,475);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/landing page2_atlas_1.png?1700092632032", id:"landing page2_atlas_1"}
	],
	preloads: []
};
