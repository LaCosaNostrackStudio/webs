...
lib.ssMetadata = [
		{name:"landing page2_atlas_1", frames: [[0,877,881,133],[966,0,604,640],[0,0,964,875],[966,642,569,651],[0,1012,194,154]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-679,-185,0.9704,0.9704);

	this.instance_1 = new lib.Mapadebits12();
	this.instance_1.setTransform(-482,-437.5);
...
p.nominalBounds = new cjs.Rectangle(-679,-437.5,1161,884.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1379,437.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},74,cjs.Ease.get(1)).to({x:452,y:439.45},85,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-227,0,2088,886.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(215.05,258.1,1.0931,1.0931,0,0,0,128.3,128.3);

	this.instance_1 = new lib.Símbolo4();
	this.instance_1.setTransform(480.1,61.1,1.1842,1.1842,0,0,0,202.6,42.3);

	this.instance_2 = new lib.Símbolo10();
	this.instance_2.setTransform(710,445.2,1,1,0,0,0,482,437.5);
...
p.nominalBounds = new cjs.Rectangle(565,407.7,1524,484.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/landing page2_atlas_1.png?1701915646435", id:"landing page2_atlas_1"}
	],
	preloads: []
};
