...
if (reversed == null) { reversed = false; }
	...
	// Capa_5
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(1,1,1).p("AvkAAIfJAA");
	this.shape.setTransform(486.35,920.45);
	...
	this.instance_1.setTransform(0,0,1.1125,1.1125);
	...
	this.instance_3.setTransform(490.15,503.5,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/web_atlas_1.png?1748612001038", id:"web_atlas_1"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1748612001234", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1748612001234", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1748612001234", id:"an.Video"}
	],
	preloads: []
};
