...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1901,1154,137,265],[1810,1518,140,265],[1725,0,137,265],[854,1658,609,246],[0,942,1698,362],[0,0,1723,940],[854,1306,700,350],[0,1306,852,455],[1700,1154,147,147],[0,1763,807,128],[1901,1421,47,45],[1465,1658,343,210],[1556,1306,343,210],[1700,942,343,210]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FDC410").s().p("EgvWAGaQiqAAh4h4Qh4h4AAiqQAAipB4h4QB4h4CqAAMBetAAAQCqAAB4B4QB4B4AACpQAACqh4B4Qh4B4iqAAg");
...
p.nominalBounds = new cjs.Rectangle(-344,-41,688.1,82);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0033FF").s().p("");
	this.shape.setTransform(69.325,46.175);
...
p.nominalBounds = new cjs.Rectangle(0,0,138.7,92.4);
...
}).prototype = getMCSymbolPrototype(lib.Symbol14, new cjs.Rectangle(0,0,68.5,132.5), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol13, new cjs.Rectangle(0,0,70,132.5), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol12, new cjs.Rectangle(0,0,68.5,132.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDC410").s().p("ApnJpQkAkAAAlpQAAloEAj/QD/kAFoAAQFpAAEAEAQD/D/AAFoQAAFpj/EAQkAD/lpAAQloAAj/j/g");
	this.shape.setTransform(87.2,87.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol11, new cjs.Rectangle(0,0,174.4,174.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.996)").s().p("EguZAHVQjCAAiKiJQiJiKAAjCQAAjCCJiJQCKiJDCgBMBczAAAQDCABCKCJQCJCJAADCQAADCiJCKQiKCJjCAAg");
	this.shape.setTransform(343.925,46.95);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol10, new cjs.Rectangle(0,0,687.9,93.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.996)").s().p("Ehxhgz+MDjDAAAMAAAAyBUh5pgN2hpaBDyg");
	this.shape.setTransform(726.625,332.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol9, new cjs.Rectangle(0,0,1453.3,665.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,197,17,0.996)").s().p("EhlUAhaMgHFgjRUB7RAQiBXQgwEMAGSBCzg");
	this.shape.setTransform(648.475,213.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-45.3,0,1387.6,427.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#B639EB","#0099FF"],[0,1],29.7,880.1,-29.9,-880.6).s().p("EhKNCE0MAAAkJnMCUbAAAMAAAEJng");
	this.shape.setTransform(475,850);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(254,197,17,0.996)").s().p("Eg6AAeiQjPAAiTiSQiSiTAAjOMAAAgtcQAAjQCSiSQCTiTDPAAMB0BAAAQDPAACTCTQCSCSAADQMAAAAtcQAADOiSCTQiTCSjPAAUg4bgJgg7mAJgg");
	this.shape.setTransform(421.325,195.45);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol6, new cjs.Rectangle(0,0,842.7,390.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(241.85,55.4,1,1,0,0,0,69.3,46.1);
...
}).prototype = getMCSymbolPrototype(lib.Symbol39, new cjs.Rectangle(0,0,477.5,112.4), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_451 = new cjs.Graphics().p("EgvWAGaQiqAAh4h4Qh4h4AAiqQAAipB4h4QB4h4CqAAMBetAAAQCqAAB4B4QB4B4AACpQAACqh4B4Qh4B4iqAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:339.075,y:41}).wait(451).to({graphics:mask_graphics_451,x:339.075,y:41}).wait(21));
...
p.nominalBounds = new cjs.Rectangle(-7.5,-74.9,1099.5,256.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(671.1,213.8,1,1,0,0,0,671.1,213.8);
	this.instance_1.shadow = new cjs.Shadow("rgba(0,0,0,1)",-4,-1,56);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol19, new cjs.Rectangle(-108.3,-61,1509,549), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(726.6,332.7,1,1,0,0,0,726.6,332.7);
	this.instance_2.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,90);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(58.95,66.2,1,1,0,0,0,34.2,66.2);

	this.instance_1 = new lib.Symbol11();
	this.instance_1.setTransform(56.65,63.4,0.6497,0.6497,0,0,0,87.2,87.3);

	this.instance_2 = new lib.Symbol10();
	this.instance_2.setTransform(400.55,63.45,1,1,0,0,0,343.9,47);
	this.instance_2.shadow = new cjs.Shadow("rgba(102,0,153,1)",12,12,28);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol17, new cjs.Rectangle(0,-1.5,790.7,158), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(59.75,66.2,1,1,0,0,0,35,66.2);

	this.instance_1 = new lib.Symbol11();
	this.instance_1.setTransform(56.65,65.5,0.6497,0.6497,0,0,0,87.2,87.3);

	this.instance_2 = new lib.Symbol10();
	this.instance_2.setTransform(400.55,65.55,1,1,0,0,0,343.9,47);
	this.instance_2.shadow = new cjs.Shadow("rgba(102,0,153,1)",12,12,28);
...
}).prototype = getMCSymbolPrototype(lib.Symbol16, new cjs.Rectangle(0,0,790.7,158.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.Symbol11();
	this.instance_1.setTransform(56.65,67.65,0.6497,0.6497,0,0,0,87.2,87.3);

	this.instance_2 = new lib.Symbol10();
	this.instance_2.setTransform(400.55,67.7,1,1,0,0,0,343.9,47);
	this.instance_2.shadow = new cjs.Shadow("rgba(102,0,153,1)",12,12,28);
...
}).prototype = getMCSymbolPrototype(lib.Symbol15, new cjs.Rectangle(0,0,790.7,160.7), null);
...
p.nominalBounds = new cjs.Rectangle(-32,-32,1804.6,1206.3);


// stage content:
(lib.triviagame3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1664745224938", id:"index_atlas_1"}
	],
	preloads: []
};
