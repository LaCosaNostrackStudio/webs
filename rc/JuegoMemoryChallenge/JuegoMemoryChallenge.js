...
lib.ssMetadata = [
		{name:"JuegoMemoryChallenge_atlas_1", frames: [[0,804,1280,720],[1401,182,82,82],[1810,0,164,40],[1401,112,206,68],[1401,0,407,58],[1282,804,523,141],[0,0,1399,802],[1401,60,470,50]]}
];
...
(lib.avibrantandsurrealillustrationofacolorfulbLxO6OFv7T6SBcERnbmOegCVUiinvZS_e8fFeAYdZ5nQ = function() {
	this.initialize(ss["JuegoMemoryChallenge_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(162.2717,58.855);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_34, new cjs.Rectangle(0,0,324.6,117.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(70.7864,38.9701);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_15, new cjs.Rectangle(0,0,141.6,78), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("ABvCEQgSg2gmgnQgngmg0gRQg1gSg2AHIgBjTQAOADAOAVQAbAsABBfQAggDApANQBQAYAtBLQAsBNgMBHQgGAlgPAUQAIg2gSg1g");
	this.shape.setTransform(14.4536,23.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_8, new cjs.Rectangle(0,0,28.9,47.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AkSghQA/g5BRgJQBTgJBNAnQBOAnAqBHQA1geA7ALQA8ALAoAuQg0gSg5AFQg5AFgvAbQgihEhIgnQhFgohOACQhSADhAAiQhGAlgpBLQAbhRA8g2g");
	this.shape.setTransform(36.175,10.1915);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_3, new cjs.Rectangle(0,0,72.4,20.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgpAXQgvgXgygFQAhgJAhACQAiACAeANQAXglAngYQAogYAtgDQgvAXgdAwQgcAvACA1QghgngtgYg");
	this.shape.setTransform(13.925,8.575);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_2, new cjs.Rectangle(0,0,27.9,17.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AB4BoQgMhNgghAQglhNhHg7Qg9gzhLgcIADAAQBUgDBUAwQBUAwAsBJQAqBHgFBiQgFBfgsBLQAMhGgLhPg");
	this.shape.setTransform(16.8763,25.3162);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_1_0, new cjs.Rectangle(0,0,33.8,50.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgnBQQgLgGgHgKQgPgUAAgWQgBgjADgLQAEgXATgNQAVgOAlgHQAigGAcADQgFBPgUAoQgJAUgRAOQgTAQgSAAIgCABQgLAAgLgGg");
	this.shape.setTransform(7.3708,8.5519);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Group_1, new cjs.Rectangle(0.1,0,14.6,17.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(311.15,180.1,1,1,0,0,0,16.9,25.3);
	this.instance.alpha = 0.3008;

	this.instance_1 = new lib.Group_2();
	this.instance_1.setTransform(69.7,136.35,1,1,0,0,0,13.9,8.6);
	this.instance_1.alpha = 0.3008;

	this.instance_2 = new lib.Group_3();
	this.instance_2.setTransform(167.35,113.25,1,1,0,0,0,36.1,10.2);
	this.instance_2.alpha = 0.3008;

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1A2E35").s().p("AhgAUQAAgBAHgFIASgLQAggQAlgEQAkgEAiAHIAVAGIAHAEIgcgGQgigGgkAEQgjAFggANIgaAOIgBAAg");
	this.shape.setTransform(191.9516,121.2313);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#1A2E35").s().p("ABAAZQgagUgggPQgfgQgggIQgcgGAAgBQAAgCAcAGQAfAFAiARQAgAPAaAWQAWATgCACIgWgSg");
	this.shape_1.setTransform(64.2799,139.9483);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#1A2E35").s().p("ABNDQQgZgIgcgRQgjgVgcgiQgigogPg1QgOgzAIg0QAHgrAUgmQAPgdASgTIALgLIAEgEIgOAQQgRAWgOAaQgTAlgGArQgIA0AOAyQAOAxAhApQAcAjAiAVQAaARAZAJIAUAHg");
	this.shape_2.setTransform(82.6512,151.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#1A2E35").s().p("AEXCKQACgogOgxIgKgcIgOgdIgSgdIgWgdQghgkgZgRQglgYgngMQgpgLgqABQgfABguAMIgiANIgQAIIgPAIQgTALgJAGIgXATQglAhgUAkIgQAcIAHgRQADgGAEgGQATglAmgiIAXgTIAbgSIAggQIAigNQAtgNAigBQAugBAmALQApANAlAYQAcATAfAjIAWAdQAHAKALAUIAOAdIAJAdQAOAwgDAqIgEAhg");
	this.shape_3.setTransform(158.2773,124.7958);

	this.instance_3 = new lib.Group_8();
	this.instance_3.setTransform(192.05,87.6,1,1,0,0,0,14.5,23.9);
	this.instance_3.alpha = 0.3008;

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#1A2E35").s().p("AjaCPIAAgGIACgRQACgcANgjQAQgtAdglQAlgwAygdQA2geA4gHQAxgGAuAIQAhAGAdANIAUAKIgVgIQgcgLghgGQgugIgxAHQg2AHg1AdQgyAegjAuQgfAmgPAqQgMAfgFAfIgDAXIgBAAg");
	this.shape_4.setTransform(120.4,90.8764);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#1A2E35").s().p("AgyBOQgQgMgEgUQgEgOABgaQABgYAGgPQAHgSARgMQAXgSAjgFQAWgCAUABQAQAAAAABIgQABQgeABgMACQgiAFgVASQgQALgGARQgGAQgBAVQgBAZAEAOQAEASAOAMQANAKARgBQAMgBANgIQARgMAOgQIAKgMIgCADQgCAFgEAFQgNARgSANQgNAJgOABIgEAAQgQAAgNgKg");
	this.shape_5.setTransform(205.915,215.7194);

	this.instance_4 = new lib.Group_1();
	this.instance_4.setTransform(206.05,215.7,1,1,0,0,0,7.4,8.6);
	this.instance_4.alpha = 0.3008;

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#1A2E35").s().p("AiXCxQhQhFgMhlQgMhjA/hJQA/hKBlgDQBkgDBQBFQBQBGAMBkQAMBjg/BKQg/BJhlADIgIAAQhfAAhNhCg");
	this.shape_6.setTransform(160.075,186.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AivDNQhQhGgFhtQgFhrBJhVQBJhUBsgMQBrgLBQBGQBQBFAFBsQAFBrhJBWQhJBVhsAKIgcACQhaAAhFg7g");
	this.shape_7.setTransform(156.825,190.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#1A2E35").s().p("AhUDZQhigmgthbQgthaAjhaQAjhaBfgkQBegkBiAmQBiAnAtBaQAtBagkBaQgjBaheAkQguASgvAAQgwAAgzgUg");
	this.shape_8.setTransform(245.6623,172.6434);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhhD8QhigmgphmQgphkAohoQAphoBjguQBhgvBiAnQBjAmApBlQApBlgpBnQgpBohiAvQg2AZg1AAQgtAAgsgRg");
	this.shape_9.setTransform(243.8437,177.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#1A2E35").s().p("ABpAtQhXgJgSgBQgSgBhYABQgxABgJgLQgFgIAIgMQAKgLAWgMQAXgOAigHQAmgJAmACQAnACAlAMQAhALAWAPQAUANAIANQAHANgGAHQgGAHgYAAQgMAAgRgCg");
	this.shape_10.setTransform(235.3753,113.3255);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#1A2E35").s().p("AisBKQgGgGAHgQQAHgQASgUQAvgxBMgaQBMgZBDALQAbAFAPAIQAPAJgBAIQgBAOg1AOQhiAZgWAIQgVAHhdAmQgjAOgPAAQgHAAgDgDg");
	this.shape_11.setTransform(147.7397,158.9717);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#1A2E35").s().p("AgYAZIAZgYIAQgSIAHgIQACABgGAJQgGALgJAJQgJAJgKAHQgHAFgCAAIgBgBg");
	this.shape_12.setTransform(209.5661,250.4161);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#1A2E35").s().p("AgYAZIAIgHIARgRIAQgSIAHgIQABABgFAJQgHALgJAIQgIAKgKAHIgJAFIgBgBg");
	this.shape_13.setTransform(210.5062,269.9562);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#1A2E35").s().p("AgYAZIAZgYIAQgSIAHgIQACABgGAJQgGALgJAJQgJAKgKAGQgHAFgCAAIgBgBg");
	this.shape_14.setTransform(211.2661,259.7161);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#1A2E35").s().p("AAUB1IgNgYQgRgmgKgyQgJgxAEgqQAAgJABgHIACgMIADgKIgDAmQgBAoAIAyQAKAzAPAkIAMAZIAFAJg");
	this.shape_15.setTransform(180.3533,261.975);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AhrB/QgagOgLg4QgRhPALhUQACgNAFgGQAGgHARABIBYAEQA1ADAhAHQAEABAHALQAGAKAEgDIBQCCQgvArg5AaQg3AZg8AGIgOAAQgSAAgLgFg");
	this.shape_16.setTransform(179.655,264.8347);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("");
	this.shape_17.setTransform(197.7568,255.4388);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#1A2E35").s().p("ACQFiQipghiBhLQiRhUhViKQhbiSANibQgBgaAMgZQAWg0A6ABQA1ABAVAeQAKAPAAAOQAACVA6BpQA6BpB3BBQBqA7CMATQBgAOCngDIAIC6IgHAAQixAAiJgag");
	this.shape_18.setTransform(122.4245,238.1495);

	this.instance_5 = new lib.Group_15();
	this.instance_5.setTransform(146.75,244,1,1,0,0,0,70.8,39);
	this.instance_5.alpha = 0.3008;

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#1A2E35").s().p("AgJBiQAJgSAIgWQAKgbAEgaQAEgWABgfQgBgbgDgSQgJgoABAAIAEAKQADAHABAGIAEARQAEATAAAaQABAZgFAdQgEAXgKAeQgKAXgJASIgJAPQgEAHgEADIgHAJQAJgNAMgXg");
	this.shape_19.setTransform(214.0333,80.0239);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#1A2E35").s().p("AgxBFIATgRQAZgVAPgXQARgXANgdIAJgYQADAAgJAZQgLAfgSAXQgRAbgZARQgSAOgDAAIAAAAg");
	this.shape_20.setTransform(315.7028,155.4481);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#1A2E35").s().p("AB8EbIAGgTQAKghAFgrQAHg4gHg5QgJhIgdg9QgNgdgWgiQgSgagYgaQgpgtgugbQgjgWgigNIgagKIAbAIQAhAMAlAWQAvAcApAsQAYAZATAbQAXAjANAdQAdA9AJBJQAHA7gIA4QgGAsgLAfIgHAUQgCAGgBABg");
	this.shape_21.setTransform(308.5133,183.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#1A2E35").s().p("AhKAnIADgGIALgPQAUgWAegQQAdgQAfgCIATAAIAHABIgaADQgdADgcAPQgdAQgVAUQgQATgBAAIAAAAg");
	this.shape_22.setTransform(280.8969,107.5673);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#1A2E35").s().p("Ag0C0QAPgMASgUQAyg6AThJQAThJgRhKQgEgVgIgXIgGgQQAAAAAAAAQABAAAAABQAAAAAAABQABABAAABIAGALQAJAXAFAVQATBKgUBLQgUBMg0A4QgRATgQAMIgKAIIgEACg");
	this.shape_23.setTransform(267.3128,112.9577);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#1A2E35").s().p("AhpCEIAnggQAvgpAjguQAmguAdg2IAWgtQABAAgFANQgFAOgKAUQgZAzgoAyQgoAygtAlQgRAOgMAIIgLAIIgBgBg");
	this.shape_24.setTransform(287.3077,217.2056);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#1A2E35").s().p("ABGDhIAChFQAAg1gCgcQgDg2gJgrQgFgYgIgaQgIgWgKgWQgTglgZgdQgQgSgZgSIgRgLIASAKQAXAPATAUQAbAcATAmQAMAZAHATQAIAbAFAYQAQBKgEBpIgEBKIgBgFg");
	this.shape_25.setTransform(296.0307,242.35);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#1A2E35").s().p("AgNBeQAXgrAKgtQAJgmACg3IACgnQABAAAAALQABAOAAAOQAAA2gKAoQgKAugZArIgRAXIgHAIIAVghg");
	this.shape_26.setTransform(242.7583,283.775);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#1A2E35").s().p("ABIBeQgIgEgQgLQglgagdgmQgegjgTgqIgKgbIgDgJQABgBAQAjQATAoAeAkQAcAkAkAcIAfAXg");
	this.shape_27.setTransform(170.9,292.3246);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#1A2E35").s().p("AA/BZQgUgFgZgNQgagPgVgTQgqgkgVgxQgIgQgDgOIgDgMIAFAMQAFAPAHAOQAWAvApAjQAWAUAYAOQAaAOASAEQAQAFAPgCIAMgDQAAACgMACQgGACgIAAQgIAAgKgCg");
	this.shape_28.setTransform(95.925,245.5317);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#1A2E35").s().p("AA0EwIgLgPQgWgggQgdQgYgvgQgzQgJgggFgdQgFglABgeQAAg/AQhAQAOg2AWguQAQgkASgaIALgQIAEgFIgNAWQgSAdgPAiQgyBrAAB2QAAAjAEAfQAFAgAJAdQAPAzAYAuQAOAcAVAhIAOAWIAAAAIgEgFg");
	this.shape_29.setTransform(111.0227,265.4271);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#1A2E35").s().p("AAPCZIgHgOIgIgTQgHgZgGgcQgGgegBgkQgBgeAFgkQAEgaAIgbIAMgiIAGgLIgEAMQgHARgDARQgHAagEAbQgEAiAAAfQABAgAGAhQAFAcAHAYQAJAdAIASg");
	this.shape_30.setTransform(50.4227,240.8);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#1A2E35").s().p("AgUBJQgzgKgsgbQgmgXgbgcQgXgagLgTIgIgNIgCgFIALARQARAYASATQAfAeAiAUQArAaAzAKQAwAKAzgIQAqgFAlgRQAdgMAUgOIARgLIgQANQgWAPgaANQgkAQgsAHQgXAEgWAAQgdAAgbgGg");
	this.shape_31.setTransform(53.825,176.4147);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#1A2E35").s().p("AiYArIAJgJIAMgKIAQgMQAVgNAZgLQAegOAegHQAegHAhgCQAdAAAXADQAIAAAMADIAPAEQAMADAAABQgSgFgdgDQgWgCgeABQgjADgaAGQgeAHgeANQgaAKgUANIgcAUIgLAIIAAAAg");
	this.shape_32.setTransform(61.025,97.4729);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#1A2E35").s().p("AhQB9IAHgjQAIgZAJgYQAOgfAPgaQARgcATgYQAWgZAOgNQAMgMAPgLIALgIIgJAJIgaAYQgPAPgUAYQgWAegNAWQgPAXgOAhQgLAagHAXQgJAcgEASg");
	this.shape_33.setTransform(123.6763,65.425);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#1A2E35").s().p("AAOB9QgugKgngdQgngegWgqQgUgkgFglQgEgcADgZIADgSQABAAgCATQgCAZAFAaQAGAkATAjQAVApAnAeQAmAcAtALQAnAJAmgFQAagCAYgJIASgGIgEACIgNAGQgYAKgbADQgPACgOAAQgYAAgZgGg");
	this.shape_34.setTransform(251.265,261.8543);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#1A2E35").s().p("AFnD4QALgSAHgSQAbhFgJhKQgFgxgWgvQgYg1gogrQgqgug6ggQg9gihEgMQhGgNhCALQhBAJg4AfQhgA0g7BgQgTAcgSAtQgNAlgEAYIgIA1IAAgDIACgcIAEgXQAFgeALgfQATguASgcQA7hiBhg0QA5ggBBgJQBDgLBHAMQBFANA9AiQA7AhAqAvQAoAsAZA2QAWAwAFAwQAIBMgdBFQgNAggNAPg");
	this.shape_35.setTransform(177.6463,248.63);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#1A2E35").s().p("AESBRIgLgQQgSgagcgaQgjghgxgYQg4gdhAgGQg/gFg8ARQgzAPgrAbQghAVgVAVIgOANIgFAEIAFgFIAMgOQAWgWAggVQAqgcA0gQQA+gSBAAGQBBAGA4AeQAxAYAkAjQAbAaASAbIAKAQIADAGg");
	this.shape_36.setTransform(95.925,193.3606);

	this.instance_6 = new lib.Group_34();
	this.instance_6.setTransform(180.9,251.35,1,1,0,0,0,162.2,58.9);
	this.instance_6.alpha = 0.3008;

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FF735D").s().p("");
	this.shape_37.setTransform(164.6887,184.9672);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FF735D").s().p("AJsQ3I7k9rQAyhnBGhGQBPhQBdgWQBmgZBfA4QBjA6APBoQAphjBjg4QBgg1BqAMQBsANBVA1QBaA4AxBdQBYgcA9gGQBDgHBVAOQBUAOBMAzQBNA0AtBLQA0BWAWBTQAbBkgWBQQB0AgBaBbQBZBbAjB4QAkB4gbCBQgZCBhOBfQBUBiAKCOQAJCOhGBuQhHBuiAArQg9AVg7AAQhAAAg9gZg");
	this.shape_38.setTransform(230.7996,155.0044);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#F5F5F5").s().p("Ag7gdIBdgcIAaBXIhdAbg");
	this.shape_39.setTransform(382.25,156.7);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#F5F5F5").s().p("AgUBHQAtgFAbgWQAWgSAHgaQAGgUgEgVQgEgUgNgQQgOgSgUgIQgZgKgbAJQgzAPgJAuQgEAXAFATIhdAaQgghoA8hAQAjgmA9gSQA5gQA6ASQBRAaAbBZQAaBYgyBIQgPAWgVASIgSANIAOAyIhcAbg");
	this.shape_40.setTransform(373.3662,129.3861);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#F5F5F5").s().p("AhJgkIBzgiIAgBrIhzAig");
	this.shape_41.setTransform(181.075,59.55);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#F5F5F5").s().p("AgZBYQA4gGAigcQAbgWAJggQAHgZgFgZQgFgagQgUQgRgVgZgKQgfgNgiALQg/ATgLA4QgFAdAHAYIh0AgQgniBBKhQQAsguBLgWQBGgVBJAXQBkAgAhBvQAgBtg9BYQgTAcgaAWIgXAQIASA+IhyAhg");
	this.shape_42.setTransform(170.0912,25.7239);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#F5F5F5").s().p("AhIg1ICDgPIAOB6IiDAPg");
	this.shape_43.setTransform(29.3,283.525);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#F5F5F5").s().p("Ag0BZQA9AEAqgXQAigTAQgiQAMgZAAgcQAAgcgOgZQgPgagYgQQgfgUgnAFQhIAJgWA7QgMAdADAcIiDAOQgRiVBfhHQA5grBUgJQBRgJBKAnQBmA2AOB+QANB9hTBTQgpAqgtARIAIBGIiBAOg");
	this.shape_44.setTransform(24.7339,244.9406);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#ECECEC").s().p("AhEA0IANh0IB8ANIgMB0g");
	this.shape_45.setTransform(356.8,246.775);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#ECECEC").s().p("AhfD/IAUi4QA5ARAqgNQAkgLAVgcQARgWAFgZQAGgbgIgZQgIgcgUgTQgZgZgmgDQhDgGghAyQgKAPgGAUQgDAJAAAHIh9gOQAOiOBngvQA+gcBPAJQBNAJA9AzQBUBGgNB4QgNB3heA8QgdATgiALIgcAHIgIBDg");
	this.shape_46.setTransform(361.3121,210.0155);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#ECECEC").s().p("AhdAyIAliLICWAoIglCMg");
	this.shape_47.setTransform(83.325,16.3);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#ECECEC").s().p("AhDFAQhdgZhBhKQhZhmAmiQQAniPB+g5QBAgcA2ABIAWhRICUAoIg6DdQhDgfg2AHQguAHggAeQgYAXgLAfQgMAfAEAhQAFAjAUAbQAaAjAuAMQBRAUAyg2QAQgRAKgXIAIgTICWAoQgsCqiIAmQglALgqAAQgtAAg0gOg");
	this.shape_48.setTransform(69.696,60.4773);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#E1E1E1").s().p("AhfBZIAAixIC/AAIAACxg");
	this.shape_49.setTransform(274.725,110.3);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#E1E1E1").s().p("AhfGTIAAkYQBZAPA+gaQA0gWAcgvQAWgjAEgnQAEgqgQglQgRgpgggZQgqgig7ABQhnACgpBRQgNAZgGAeQgCAPAAAKIi/AAQgCjYCUhYQBYg0B6AAQB3AABkBDQCLBdAAC4QAAC1iEBsQgqAhgxAWIgqAPIAABmg");
	this.shape_50.setTransform(274.7987,53.775);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#E1E1E1").s().p("AgTATIAAglIAnAAIAAAlg");
	this.shape_51.setTransform(355.05,86.7);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#E1E1E1").s().p("AgTBWIAAg8QAiAGAOgXQAKgPgHgQQgJgWgXAAQgVABgJARIgEARIgqAAQAAguAggTQATgLAZAAQAaAAAVAOQAeAVgBAnQAAAmgbAXIgdAOIAAAWg");
	this.shape_52.setTransform(355.0496,74.65);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#E1E1E1").s().p("");
	this.shape_53.setTransform(354.857,76.8042);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#FFFFFF").s().p("Ag+DdQg/gTgrgxIhBgBIAWhFQgchKAWhKQAchcBUgtQBUgtBaAbQBcAcAtBUQAtBUgbBaQgcBchUAtQg0Acg3AAQghAAgigKg");
	this.shape_54.setTransform(354.768,76.825);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#E1E1E1").s().p("AgqAWIASg+IBDATIgSA+g");
	this.shape_55.setTransform(79.45,331.4);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#E1E1E1").s().p("AhSCEIAchjQAeAOAYgDQAVgDAPgNQAYgXgEgeQgCgQgJgMQgLgQgVgGQgkgKgXAZQgMAMgEAOIhEgTQAVhNA+gQQAkgKArAMQArAMAcAiQAoAvgSBAQgSBBg6AZQgSAIgUADIgPABIgLAkg");
	this.shape_56.setTransform(85.9675,311.4651);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#E1E1E1").s().p("AgrAOIAbg3IA8AcIgbA3g");
	this.shape_57.setTransform(4.35,180.975);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#E1E1E1").s().p("AhoBxIAqhYQAaASAYABQASABAQgKQAagRABgdQABgPgGgNQgJgRgSgIQgggPgZATQgNAKgGAMIg8gcQAghFA8gFQAigDAnASQAlARAWAlQAdAygbA5QgbA5g6AOQgSAEgSAAIgPgCIgPAgg");
	this.shape_58.setTransform(14.2384,163.1036);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_55},{t:this.shape_54},{t:this.shape_53},{t:this.shape_52},{t:this.shape_51},{t:this.shape_50},{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46},{t:this.shape_45},{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.instance_6},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.instance_5},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.instance_4},{t:this.shape_5},{t:this.shape_4},{t:this.instance_3},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(0,0,391.8,335.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 55px 'Arial'", "#FFFFFF");
	...
	this.etiketa.setTransform(16.4453,-49.1568,1.777,1.6799);
	this.etiketa.shadow = new cjs.Shadow("rgba(102,0,255,1)",0,0,9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 4
	this.instance = new lib.Símbolo1();
	this.instance.setTransform(18.2,41,0.6096,0.6096,0,0,0,195.8,167.7);
...
p.nominalBounds = new cjs.Rectangle(-102.4,-62.5,273.8,205.8);
...
// stage content:
(lib.JuegoMemoryChallenge = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.bt14.name = "bt14";
	this.bt14.setTransform(-438.2,-271.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt13 = new lib.Symbol12_1();
	this.bt13.name = "bt13";
	this.bt13.setTransform(-634.15,-271.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt12 = new lib.Symbol12_1();
	this.bt12.name = "bt12";
	this.bt12.setTransform(-836.7,-271.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.name = "bt11";
	this.bt11.setTransform(-1047.1,-271.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12_1();
	this.bt10.name = "bt10";
	this.bt10.setTransform(1105.4,431.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.name = "bt9";
	this.bt9.setTransform(877.45,430.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.name = "bt8";
	this.bt8.setTransform(629.2,430.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.name = "bt7";
	this.bt7.setTransform(391.8,430.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.name = "bt6";
	this.bt6.setTransform(170.25,430.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.name = "bt5";
	this.bt5.setTransform(1105.4,175.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.name = "bt4";
	this.bt4.setTransform(877.45,175.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.name = "bt3";
	this.bt3.setTransform(644.7,175.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.name = "bt2";
	this.bt2.setTransform(407.3,175.25,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(170.25,175.25,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.instance_1.setTransform(499,652);

	this.instance_2 = new lib.avibrantandsurrealillustrationofacolorfulbLxO6OFv7T6SBcERnbmOegCVUiinvZS_e8fFeAYdZ5nQ();
...
p.nominalBounds = new cjs.Rectangle(-497.2,-231.8,1842,1143.9);
// library properties:
lib.properties = {
	id: '5400D4393F9AA44C941975592C01B3C1',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/JuegoMemoryChallenge_atlas_1.png?1728077824822", id:"JuegoMemoryChallenge_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1728077824975", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1728077824975", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1728077824975", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1728077824975", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1728077824975", id:"an.Video"}
	],
	preloads: []
};
...
an.compositions['5400D4393F9AA44C941975592C01B3C1'] = {
