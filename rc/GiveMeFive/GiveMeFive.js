...
lib.ssMetadata = [
		{name:"GiveMeFive_atlas_1", frames: [[0,804,1280,720],[1603,182,82,82],[1810,0,164,40],[1401,112,206,68],[1401,182,200,68],[1401,0,407,58],[1282,804,523,141],[0,0,1399,802],[1401,60,470,50]]}
];
...
(lib.avibrantandplayfulillustrationfeaturingfivewpw8OKocS2qO9vZmG1I9tAL5jsPTCzSa2S5o9O4j7t6A = function() {
	this.initialize(ss["GiveMeFive_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "50px 'Impact'", "#660099");
	...
	this.etiketa.setTransform(-3.0046,23.5864,1.777,1.2463);
	this.etiketa.shadow = new cjs.Shadow("rgba(255,255,255,1)",3,3,4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#660099").ss(1,1,1).p("");
	this.shape.setTransform(7.0389,-8.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F9D4C1").s().p("");
	this.shape_1.setTransform(7.0389,5.4634);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#660099").ss(1,1,1).p("AmRAKIAKAeQACAHAHAsQAEAeAPAWQATAeAlAeQAeAYAZAJQBnAhBdghIAAgDQAUgNARgQQAWgLAWgQQA0gkBHh3QBEhvA/giQAWgMA1gYQArgYAFgkQACgTgGgN");
	this.shape_2.setTransform(32.9508,74.9374,2.1801,2.0144);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F7C9B2").s().p("Aj8DsQgZgJgegYQglgegTgeQgPgWgEgeQgHgsgCgHIgKgeQBFBOBaAYQBiAZBJg2QBKhACViDQCEhrByggQAGANgCATQgFAkgrAYQg1AYgWAMQg/AihEBvQhHB3g0AkQgWAQgWALQgRAQgUANIAAADQgvAQgwAAQgxAAg0gQg");
	this.shape_3.setTransform(32.9508,74.9374,2.1801,2.0144);
...
p.nominalBounds = new cjs.Rectangle(-114.8,-94.5,286.2,231.6);
...
// stage content:
(lib.GiveMeFive = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.bt11.name = "bt11";
	this.bt11.setTransform(-519.75,95.3,0.6986,0.6985,0,0,0,-0.1,0.1);
	...
	this.bt10.name = "bt10";
	this.bt10.setTransform(1030.25,435.75,0.9054,0.9053,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(832.35,431.9,0.9055,0.9054,0,0,0,0,0.4);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(609.1,432.45,0.9055,0.9051,0,0,0,0,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(388.25,455.55,0.9054,0.9052,0,0,0,2.6,25.7);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(189.6,432.4,0.9055,0.9053,0,0,0,0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(1044.05,217.95,0.9056,0.9053,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(834.3,218.05,0.9054,0.9052,0,0,0,0.1,0.4);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(608.9,220.35,0.9055,0.9048,0,0,0,-0.2,0.6);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(395.6,217.75,0.9055,0.9055);

	this.bt1 = new lib.Symbol12();
	this.bt1.name = "bt1";
	this.bt1.setTransform(189.4,219.8,0.9055,0.9055,0,0,0,-0.1,0.1);
	...
	this.instance_2 = new lib.avibrantandplayfulillustrationfeaturingfivewpw8OKocS2qO9vZmG1I9tAL5jsPTCzSa2S5o9O4j7t6A();
...
p.nominalBounds = new cjs.Rectangle(-342.5,-231.8,1687.3,1368.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/GiveMeFive_atlas_1.png?1728084552289", id:"GiveMeFive_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1728084552414", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1728084552414", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1728084552414", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1728084552414", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1728084552414", id:"an.Video"}
	],
	preloads: []
};
