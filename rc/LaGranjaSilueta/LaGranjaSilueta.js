...
lib.ssMetadata = [
		{name:"LaGranjaSilueta_atlas_1", frames: [[0,804,1280,720],[1401,182,82,82],[1810,0,164,40],[1401,112,206,68],[1401,0,407,58],[1282,804,523,141],[0,0,1399,802],[1401,60,470,50]]}
];
...
(lib.adelightfulandcolorfulcartoonillustrationofX2P_XzZRDurOkyp0C3ugh9n4bBIDTRqRpHlo2WUshA = function() {
	this.initialize(ss["LaGranjaSilueta_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.adelightfulandcolorfulcartoonillustrationofX2P_XzZRDurOkyp0C3ugh9n4bBIDTRqRpHlo2WUshA();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo2, new cjs.Rectangle(0,0,1280,720), null);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 55px 'Arial'", "#009900");
	...
	this.etiketa.setTransform(13.8453,-33.6068,1.777,1.6799);
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#33CC99").ss(16,1,1).p("AQJAAQAAGskuEvQkvEumsAAQmrAAkvkuQkukvAAmsQAAmrEukvQEvkuGrAAQGsAAEvEuQEuEvAAGrg");
	this.shape.setTransform(14.975,19.625);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AraLbQkukvAAmsQAAmrEukvQEvkuGrAAQGsAAEvEuQEuEvAAGrQAAGskuEvQkvEumsAAQmrAAkvkug");
	this.shape_1.setTransform(14.975,19.625);
...
p.nominalBounds = new cjs.Rectangle(-105,-91.7,276.4,222.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.graphics.f().s("#000000").ss(12.1,1,1).p("ACKClIkTAAIAAlJ");
	this.shape_2.setTransform(13.775,16.475);
...
// stage content:
(lib.LaGranjaSilueta = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-499.4,-231.8,1844.1999999999998,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LaGranjaSilueta_atlas_1.png?1728083019327", id:"LaGranjaSilueta_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1728083019439", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1728083019439", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1728083019439", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1728083019439", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1728083019439", id:"an.Video"}
	],
	preloads: []
};
