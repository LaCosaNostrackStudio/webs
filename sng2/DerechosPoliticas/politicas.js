...
lib.ssMetadata = [
		{name:"politicas_atlas_1", frames: [[0,0,268,52],[0,54,249,3]]}
];
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["politicas_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.politicas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(380,314,0.9662,1);

	this.instance_1 = new lib.CachedBmp_7();
	this.instance_1.setTransform(432.9,287.05,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/politicas_atlas_1.png?1708533561650", id:"politicas_atlas_1"}
	],
	preloads: []
};
