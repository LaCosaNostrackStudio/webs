...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#000000").s().p("Egz0BD1MAAAiHpMBnoAAAMAAACHpg");
	this.shape.setTransform(331.65,434.05);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(0,0,663.3,868.1), null);


// stage content:
(lib.tesecarga = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_2
	this.miMovieClip = new lib.Símbolo1();
...
an.compositions['4BD252CC61B4CB40B4796DD87B957BF5'] = {
