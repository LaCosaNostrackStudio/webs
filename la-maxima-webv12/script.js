...
$('.player-close').onclick=()=>player.classList.remove('open');
...
// Se intenta reproducir al cargar. Si el navegador bloquea el sonido,
// el primer clic, toque o tecla en cualquier parte de la página lo activa.
