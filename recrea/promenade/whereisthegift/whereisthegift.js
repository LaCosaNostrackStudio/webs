...
lib.ssMetadata = [
		{name:"whereisthegift_atlas_1", frames: [[3872,944,82,82],[3872,1028,164,40],[3872,804,206,68],[3872,874,200,68],[2628,0,1399,802],[961,1068,470,50],[1602,0,1024,1536],[447,1068,512,512],[0,0,1600,1066],[961,1538,812,127],[0,1068,445,668],[3376,804,494,741],[1775,1538,812,127],[2628,804,746,505]]}
];
...
(lib.Bitmap10 = function() {
	this.initialize(ss["whereisthegift_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.Promenade_at_Coconut_Creek_Logo__2_ = function() {
	this.initialize(ss["whereisthegift_atlas_1"]);
	this.gotoAndStop(12);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Promenade_at_Coconut_Creek_Logo__2_();
	this.instance.setTransform(-42,70,0.2249,0.2249);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_7
	this.instance_1 = new lib.footerlogo();
	this.instance_1.setTransform(322,18,0.715,0.715);
	...
	// Layer 3
	this.instance_3 = new lib.foonfo();
	this.instance_3.setTransform(-16,-73,0.8408,0.8408);
...
p.nominalBounds = new cjs.Rectangle(-60.2,52.6,1405,1303.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/whereisthegift_atlas_1.png?1759670502663", id:"whereisthegift_atlas_1"},
		{src:"sounds/checkpoint.mp3?1759670502962", id:"checkpoint"},
		{src:"sounds/click.mp3?1759670502962", id:"click"},
		{src:"sounds/click2.mp3?1759670502962", id:"click2"},
		{src:"sounds/CORNETAPERDIO.mp3?1759670502962", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1759670502962", id:"CORNETAUNAVEZ"},
		{src:"sounds/moneda2.mp3?1759670502962", id:"moneda2"},
		{src:"sounds/sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA.mp3?1759670502962", id:"sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1759670502962", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1759670502962", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1759670502962", id:"an.Video"}
	],
	preloads: []
};
