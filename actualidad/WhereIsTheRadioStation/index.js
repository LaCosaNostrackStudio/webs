...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1026,2052,1000,667],[1228,874,82,82],[1234,804,164,40],[1026,804,206,68],[1026,874,200,68],[0,0,1399,802],[2052,1026,470,50],[1401,0,1024,1024],[0,804,1024,1024],[1026,1026,1024,1024],[0,1830,1024,1024],[2028,2052,779,431]]}
];
...
(lib.craiyon_172833_imagepngcopia = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.craiyon_173105_image = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
...
(lib.craiyon_182231_image = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(9);
}).prototype = p = new cjs.Sprite();
...
(lib.craiyon_182545_image = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(10);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_1"],11);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.2,0,0,0.2,-78,-29.8)).s().p("AsLEqIAApTIYXAAIAAJTg")
	}.bind(this);
	this.shape.setTransform(78,29.825);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo18, new cjs.Rectangle(0,0,156,59.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.craiyon_182545_image();
	this.instance.setTransform(-40,-49,0.1915,0.1915);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo3, new cjs.Rectangle(-40,-49,196.1,196.1), null);
...
p.nominalBounds = new cjs.Rectangle(-100.5,-109.5,196.1,527.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(86.45,77.55,1,1,0,0,0,78,29.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ah8D+QgpgjgMhHIBpgLQAEAfAQAQQAQAQAbAAQAgAAAYggQAYgeAGhiQgpAwg8AAQhDAAgwgzQgxgzAAhSQAAhXA0g0QAzg1BPAAQBVAAA3BDQA3BDAACXQAACbg6BEQg5BFhbAAQhDAAgogjgAg9iuQgUAXAAA3QAAA2AVAaQAWAYAgAAQAfAAAVgXQAVgZAAgvQAAg1gXgdQgZgdgeAAQgeAAgUAYg");
	this.shape.setTransform(163.275,144.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ag1A2IAAhrIBrAAIAABrg");
	this.shape_1.setTransform(131.025,167.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiAD1QgygsgJhIIBpgNQAFApAWAVQAWAVAfAAQAhAAAXgZQAXgaAAgrQAAgpgWgYQgWgYggAAQgTAAgeAIIANhXQAqABAXgUQAYgUAAgiQAAgdgRgQQgSgRgaAAQgcAAgUATQgTATgFAlIhjgRQAJgzAWgfQAVgeAmgSQAlgSAuAAQBQAAAvAzQApAqAAA0QAABLhSAsQAxALAdAjQAdAkAAA0QAABKg3A0Qg2A1hQAAQhMAAgzgsg");
	this.shape_2.setTransform(97.75,144.875);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AiEDiQgzhAAAiiQAAifA4hHQAug6BRAAQBSAAAuA7QA4BGAACfQAAChg4BGQguA6hSAAQhSAAgyg/gAgii5QgPAMgJAhQgLAqAABiQAABkAKAlQAKAlAPANQAPAMATAAQAUAAAPgMQAQgNAIggQALgqAAhkQAAhigKglQgKgmgPgMQgPgNgUAAQgTAAgPANg");
	this.shape_3.setTransform(53.725,144.875);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAQEcIAAmYQg7A4hQAaIAAhiQAqgOAygmQAxgnASg0IBYAAIAAI3g");
	this.shape_4.setTransform(6.775,144.4);

	this.instance_1 = new lib.craiyon_172833_imagepngcopia();
	this.instance_1.setTransform(-49,-90,0.2736,0.4317);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAcEcIAAhyIjmAAIAAhfID0lmIBbAAIAAFmIBGAAIAABfIhGAAIAABygAhlBLICBAAIAAjAg");
	this.shape_5.setTransform(108.775,144.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AiEDiQgzhAAAiiQAAifA4hHQAug6BRAAQBSAAAuA7QA4BGAACfQAAChg4BGQguA6hSAAQhSAAgyg/gAgii5QgPAMgJAhQgLAqAABiQAABkAKAlQAKAlAPANQAPAMATAAQAUAAAPgMQAQgNAIggQALgqAAhkQAAhigKglQgKgmgPgMQgPgNgUAAQgTAAgPANg");
	this.shape_6.setTransform(64.725,144.875);

	this.instance_2 = new lib.craiyon_182231_image();
	this.instance_2.setTransform(-49,-90,0.2736,0.4317);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhtEXQAEh2Ath5QAth5BMhgIj1AAIAAhlIFyAAIAABPQgvAtgvBVQgwBTgYBgQgZBeABBLg");
	this.shape_7.setTransform(97.9,144.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAQEcIAAmYQg7A4hQAaIAAhiQAqgOAygmQAxgnASg0IBYAAIAAI3g");
	this.shape_8.setTransform(6.775,144.4);

	this.instance_3 = new lib.craiyon_173105_image();
	this.instance_3.setTransform(-49,-90,0.2736,0.4317);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.shape_4,p:{x:6.775}},{t:this.shape_3,p:{x:53.725}},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).to({state:[{t:this.instance_2},{t:this.shape_4,p:{x:17.775}},{t:this.shape_6},{t:this.shape_5},{t:this.shape_3,p:{x:152.625}},{t:this.instance}]},1).to({state:[{t:this.instance_3},{t:this.shape_8},{t:this.shape_3,p:{x:53.725}},{t:this.shape_7},{t:this.shape_1},{t:this.shape_4,p:{x:160.575}},{t:this.instance}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-49,-90,280.2,442.1);
...
p.nominalBounds = new cjs.Rectangle(-49,-298,280.9,650.1);
...
p.nominalBounds = new cjs.Rectangle(-430.1,-90,661.3,1124.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-11,-3,0.4029,0.4029);
	...
	this.timeline.addTween(cjs.Tween.get(this.cajaa).wait(1).to({_off:false},0).to({y:355.25},28,cjs.Ease.get(1)).wait(1).to({regX:91.1,regY:472.3,x:340.2,y:715.15},0).wait(1).to({x:356.1},0).wait(1).to({x:382.65},0).wait(1).to({x:419.85},0).wait(1).to({x:467.65},0).wait(1).to({x:526.05},0).wait(1).to({x:595.1},0).wait(1).to({x:674.8},0).wait(1).to({x:765.05},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:91.1,regY:472.3,x:834.45,y:725},0).wait(1).to({x:802.6,y:734.95},0).wait(1).to({x:770.35,y:745.05},0).wait(1).to({x:737.8,y:755.25},0).wait(1).to({x:704.9,y:765.55},0).wait(1).to({x:671.65,y:775.95},0).wait(1).to({x:638.05,y:786.45},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:91.1,regY:472.3,x:565.8,y:785.4},0).wait(1).to({x:527.45,y:773.75},0).wait(1).to({x:489.05,y:762.05},0).wait(1).to({x:450.6,y:750.35},0).wait(1).to({x:412.05,y:738.6},0).wait(1).to({x:373.5,y:726.9},0).wait(1).to({regX:116,regY:112.4,x:359.8,y:355.25},0).wait(1).to({regX:91.1,regY:472.3,x:340.2,y:715.15},0).wait(1).to({x:356.1},0).wait(1).to({x:382.65},0).wait(1).to({x:419.85},0).wait(1).to({x:467.65},0).wait(1).to({x:526.05},0).wait(1).to({x:595.1},0).wait(1).to({x:674.8},0).wait(1).to({x:765.05},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:91.1,regY:472.3,x:855.05,y:718.55},0).wait(1).to({x:844.1,y:721.95},0).wait(1).to({x:833.1,y:725.4},0).wait(1).to({x:822.05,y:728.9},0).wait(1).to({x:810.95,y:732.35},0).wait(1).to({x:799.8,y:735.85},0).wait(1).to({x:788.65,y:739.35},0).wait(1).to({x:777.4,y:742.85},0).wait(1).to({x:766.15,y:746.35},0).wait(1).to({x:754.85,y:749.9},0).wait(1).to({x:743.5,y:753.45},0).wait(1).to({x:732.1,y:757},0).wait(1).to({x:720.7,y:760.6},0).wait(1).to({x:709.2,y:764.2},0).wait(1).to({x:697.7,y:767.8},0).wait(1).to({x:686.15,y:771.4},0).wait(1).to({x:674.55,y:775},0).wait(1).to({x:662.9,y:778.65},0).wait(1).to({x:651.2,y:782.3},0).wait(1).to({x:639.5,y:786},0).wait(1).to({x:627.75,y:789.65},0).wait(1).to({x:615.95,y:793.35},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:91.1,regY:472.3,x:600.45,y:795.95},0).wait(1).to({x:596.85,y:794.85},0).wait(1).to({x:593.2,y:793.75},0).wait(1).to({x:589.6,y:792.65},0).wait(1).to({x:585.95,y:791.55},0).wait(1).to({x:582.35,y:790.45},0).wait(1).to({x:578.75,y:789.35},0).wait(1).to({x:575.1,y:788.25},0).wait(1).to({x:571.5,y:787.15},0).wait(1).to({x:567.85,y:786.05},0).wait(1).to({x:564.25,y:784.95},0).wait(1).to({x:560.6,y:783.85},0).wait(1).to({x:557,y:782.75},0).wait(1).to({x:553.35,y:781.65},0).wait(1).to({x:549.75,y:780.55},0).wait(1).to({x:546.1,y:779.45},0).wait(1).to({x:542.45,y:778.3},0).wait(1).to({x:538.85,y:777.2},0).wait(1).to({x:535.2,y:776.1},0).wait(1).to({x:531.6,y:775},0).wait(1).to({x:527.95,y:773.9},0).wait(1).to({x:524.35,y:772.8},0).wait(1).to({x:520.7,y:771.7},0).wait(1).to({x:517.05,y:770.6},0).wait(1).to({x:513.45,y:769.5},0).wait(1).to({x:509.8,y:768.4},0).wait(1).to({x:506.15,y:767.25},0).wait(1).to({x:502.55,y:766.15},0).wait(1).to({x:498.9,y:765.05},0).wait(1).to({x:495.25,y:763.95},0).wait(1).to({x:491.65,y:762.85},0).wait(1).to({x:488,y:761.75},0).wait(1).to({x:484.35,y:760.65},0).wait(1).to({x:480.75,y:759.55},0).wait(1).to({x:477.1,y:758.4},0).wait(1).to({x:473.45,y:757.3},0).wait(1).to({x:469.8,y:756.2},0).wait(1).to({x:466.2,y:755.1},0).wait(1).to({x:462.55,y:754},0).wait(1).to({x:458.9,y:752.9},0).wait(1).to({x:455.25,y:751.75},0).wait(1).to({x:451.6,y:750.65},0).wait(1).to({x:448,y:749.55},0).wait(1).to({x:444.35,y:748.45},0).wait(1).to({x:440.7,y:747.35},0).wait(1).to({x:437.05,y:746.25},0).wait(1).to({x:433.4,y:745.1},0).wait(1).to({x:429.75,y:744},0).wait(1).to({x:426.15,y:742.9},0).wait(1).to({x:422.5,y:741.8},0).wait(1).to({x:418.85,y:740.7},0).wait(1).to({x:415.2,y:739.6},0).wait(1).to({x:411.55,y:738.45},0).wait(1).to({x:407.9,y:737.35},0).wait(1).to({x:404.25,y:736.25},0).wait(1).to({x:400.6,y:735.15},0).wait(1).to({x:396.95,y:734},0).wait(1).to({x:393.3,y:732.9},0).wait(1).to({x:389.65,y:731.8},0).wait(1).to({x:386,y:730.7},0).wait(1).to({x:382.35,y:729.6},0).wait(1).to({x:378.7,y:728.45},0).wait(1).to({x:375.05,y:727.35},0).wait(1).to({x:371.4,y:726.25},0).wait(1).to({x:367.75,y:725.15},0).wait(1).to({x:364.1,y:724},0).wait(1).to({x:360.45,y:722.9},0).wait(1).to({x:356.8,y:721.8},0).wait(1).to({x:353.15,y:720.7},0).wait(1).to({x:349.5,y:719.6},0).wait(1).to({x:345.85,y:718.45},0).wait(1).to({x:342.2,y:717.35},0).wait(1).to({x:338.55,y:716.25},0).wait(1).to({regX:116,regY:112.4,x:359.8,y:355.25},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.cajab).wait(1).to({_off:false},0).to({y:437.2},28,cjs.Ease.get(1)).wait(1).to({regX:91.1,regY:472.3,x:601.4,y:796.25},0).wait(1).to({x:593.35,y:793.8},0).wait(1).to({x:579.9,y:789.7},0).wait(1).to({x:561.1,y:783.95},0).wait(1).to({x:536.95,y:776.6},0).wait(1).to({x:507.4,y:767.55},0).wait(1).to({x:472.5,y:756.9},0).wait(1).to({x:432.2,y:744.65},0).wait(1).to({x:386.55,y:730.7},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:355.25},0).wait(1).to({regX:91.1,regY:472.3,x:399.5,y:715.05},0).wait(1).to({x:464.2,y:714.95},0).wait(1).to({x:529.6,y:714.85},0).wait(1).to({x:595.7,y:714.8},0).wait(1).to({x:662.55,y:714.7},0).wait(1).to({x:730.05,y:714.6},0).wait(1).to({x:798.3,y:714.5},0).wait(1).to({regX:116,regY:112.4,x:892.15,y:354.55},0).wait(1).to({regX:91.1,regY:472.3,x:829.8,y:726.2},0).wait(1).to({x:792.3,y:737.95},0).wait(1).to({x:754.75,y:749.75},0).wait(1).to({x:717.2,y:761.55},0).wait(1).to({x:679.55,y:773.4},0).wait(1).to({x:641.85,y:785.2},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:91.1,regY:472.3,x:601.4,y:796.25},0).wait(1).to({x:593.35,y:793.8},0).wait(1).to({x:579.9,y:789.7},0).wait(1).to({x:561.1,y:783.95},0).wait(1).to({x:536.95,y:776.6},0).wait(1).to({x:507.4,y:767.55},0).wait(1).to({x:472.5,y:756.9},0).wait(1).to({x:432.2,y:744.65},0).wait(1).to({x:386.55,y:730.7},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:355.25},0).wait(1).to({regX:91.1,regY:472.3,x:357.7,y:715.1},0).wait(1).to({x:379.95,y:715.05},0).wait(1).to({x:402.3},0).wait(1).to({x:424.75,y:715},0).wait(1).to({x:447.25},0).wait(1).to({x:469.85,y:714.95},0).wait(1).to({x:492.55,y:714.9},0).wait(1).to({x:515.35},0).wait(1).to({x:538.2,y:714.85},0).wait(1).to({x:561.15},0).wait(1).to({x:584.15,y:714.8},0).wait(1).to({x:607.3,y:714.75},0).wait(1).to({x:630.5},0).wait(1).to({x:653.8,y:714.7},0).wait(1).to({x:677.15},0).wait(1).to({x:700.6,y:714.65},0).wait(1).to({x:724.15,y:714.6},0).wait(1).to({x:747.8},0).wait(1).to({x:771.5,y:714.55},0).wait(1).to({x:795.3,y:714.5},0).wait(1).to({x:819.2},0).wait(1).to({x:843.15,y:714.45},0).wait(1).to({regX:116,regY:112.4,x:892.15,y:354.55},0).wait(1).to({regX:91.1,regY:472.3,x:863.7,y:715.55},0).wait(1).to({x:860.15,y:716.65},0).wait(1).to({x:856.6,y:717.75},0).wait(1).to({x:853.05,y:718.85},0).wait(1).to({x:849.55,y:720},0).wait(1).to({x:846,y:721.1},0).wait(1).to({x:842.45,y:722.2},0).wait(1).to({x:838.9,y:723.3},0).wait(1).to({x:835.35,y:724.45},0).wait(1).to({x:831.8,y:725.55},0).wait(1).to({x:828.3,y:726.65},0).wait(1).to({x:824.75,y:727.75},0).wait(1).to({x:821.2,y:728.9},0).wait(1).to({x:817.65,y:730},0).wait(1).to({x:814.1,y:731.1},0).wait(1).to({x:810.55,y:732.2},0).wait(1).to({x:807,y:733.35},0).wait(1).to({x:803.45,y:734.45},0).wait(1).to({x:799.9,y:735.55},0).wait(1).to({x:796.35,y:736.7},0).wait(1).to({x:792.8,y:737.8},0).wait(1).to({x:789.25,y:738.9},0).wait(1).to({x:785.7,y:740},0).wait(1).to({x:782.15,y:741.15},0).wait(1).to({x:778.6,y:742.25},0).wait(1).to({x:775.05,y:743.35},0).wait(1).to({x:771.5,y:744.5},0).wait(1).to({x:767.95,y:745.6},0).wait(1).to({x:764.4,y:746.7},0).wait(1).to({x:760.85,y:747.85},0).wait(1).to({x:757.3,y:748.95},0).wait(1).to({x:753.75,y:750.05},0).wait(1).to({x:750.2,y:751.2},0).wait(1).to({x:746.65,y:752.3},0).wait(1).to({x:743.1,y:753.4},0).wait(1).to({x:739.55,y:754.55},0).wait(1).to({x:736,y:755.65},0).wait(1).to({x:732.45,y:756.75},0).wait(1).to({x:728.85,y:757.9},0).wait(1).to({x:725.3,y:759},0).wait(1).to({x:721.75,y:760.1},0).wait(1).to({x:718.2,y:761.25},0).wait(1).to({x:714.65,y:762.35},0).wait(1).to({x:711.1,y:763.45},0).wait(1).to({x:707.5,y:764.6},0).wait(1).to({x:703.95,y:765.7},0).wait(1).to({x:700.4,y:766.8},0).wait(1).to({x:696.85,y:767.95},0).wait(1).to({x:693.3,y:769.05},0).wait(1).to({x:689.7,y:770.2},0).wait(1).to({x:686.15,y:771.3},0).wait(1).to({x:682.6,y:772.4},0).wait(1).to({x:679,y:773.55},0).wait(1).to({x:675.45,y:774.65},0).wait(1).to({x:671.9,y:775.75},0).wait(1).to({x:668.35,y:776.9},0).wait(1).to({x:664.75,y:778},0).wait(1).to({x:661.2,y:779.15},0).wait(1).to({x:657.65,y:780.25},0).wait(1).to({x:654.05,y:781.35},0).wait(1).to({x:650.5,y:782.5},0).wait(1).to({x:646.95,y:783.6},0).wait(1).to({x:643.35,y:784.75},0).wait(1).to({x:639.8,y:785.85},0).wait(1).to({x:636.2,y:787},0).wait(1).to({x:632.65,y:788.1},0).wait(1).to({x:629.1,y:789.2},0).wait(1).to({x:625.5,y:790.35},0).wait(1).to({x:621.95,y:791.45},0).wait(1).to({x:618.35,y:792.6},0).wait(1).to({x:614.8,y:793.7},0).wait(1).to({x:611.2,y:794.85},0).wait(1).to({x:607.65,y:795.95},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.cajac).wait(1).to({_off:false},0).to({y:355.25},28,cjs.Ease.get(1)).wait(1).to({regX:91.1,regY:472.3,x:863.35,y:715.95},0).wait(1).to({x:855.5,y:718.4},0).wait(1).to({x:842.4,y:722.5},0).wait(1).to({x:824.05,y:728.25},0).wait(1).to({x:800.5,y:735.6},0).wait(1).to({x:771.7,y:744.65},0).wait(1).to({x:737.65,y:755.3},0).wait(1).to({x:698.35,y:767.55},0).wait(1).to({x:653.85,y:781.5},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:91.1,regY:472.3,x:571.75,y:787.15},0).wait(1).to({x:539.1,y:777.05},0).wait(1).to({x:506.05,y:766.9},0).wait(1).to({x:472.65,y:756.65},0).wait(1).to({x:438.9,y:746.25},0).wait(1).to({x:404.8,y:735.75},0).wait(1).to({x:370.35,y:725.15},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:354.55},0).wait(1).to({regX:91.1,regY:472.3,x:410.95,y:714.5},0).wait(1).to({x:486.55,y:714.6},0).wait(1).to({x:562.2,y:714.7},0).wait(1).to({x:638,y:714.8},0).wait(1).to({x:713.85,y:714.9},0).wait(1).to({x:789.85,y:715},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:91.1,regY:472.3,x:863.35,y:715.95},0).wait(1).to({x:855.5,y:718.4},0).wait(1).to({x:842.4,y:722.5},0).wait(1).to({x:824.05,y:728.25},0).wait(1).to({x:800.5,y:735.6},0).wait(1).to({x:771.7,y:744.65},0).wait(1).to({x:737.65,y:755.3},0).wait(1).to({x:698.35,y:767.55},0).wait(1).to({x:653.85,y:781.5},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:91.1,regY:472.3,x:592.85,y:793.65},0).wait(1).to({x:581.65,y:790.15},0).wait(1).to({x:570.35,y:786.7},0).wait(1).to({x:559,y:783.2},0).wait(1).to({x:547.65,y:779.7},0).wait(1).to({x:536.2,y:776.2},0).wait(1).to({x:524.75,y:772.65},0).wait(1).to({x:513.25,y:769.1},0).wait(1).to({x:501.7,y:765.55},0).wait(1).to({x:490.1,y:762},0).wait(1).to({x:478.5,y:758.4},0).wait(1).to({x:466.8,y:754.85},0).wait(1).to({x:455.1,y:751.2},0).wait(1).to({x:443.35,y:747.6},0).wait(1).to({x:431.55,y:743.95},0).wait(1).to({x:419.7,y:740.3},0).wait(1).to({x:407.8,y:736.65},0).wait(1).to({x:395.85,y:733},0).wait(1).to({x:383.85,y:729.3},0).wait(1).to({x:371.85,y:725.6},0).wait(1).to({x:359.8,y:721.9},0).wait(1).to({x:347.7,y:718.15},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:354.55},0).wait(1).to({regX:91.1,regY:472.3,x:342.65,y:714.45},0).wait(1).to({x:349.8},0).wait(1).to({x:356.9},0).wait(1).to({x:364.05},0).wait(1).to({x:371.2},0).wait(1).to({x:378.35,y:714.5},0).wait(1).to({x:385.45},0).wait(1).to({x:392.6},0).wait(1).to({x:399.75},0).wait(1).to({x:406.9},0).wait(1).to({x:414.05,y:714.55},0).wait(1).to({x:421.2},0).wait(1).to({x:428.3},0).wait(1).to({x:435.45},0).wait(1).to({x:442.6},0).wait(1).to({x:449.75,y:714.6},0).wait(1).to({x:456.9},0).wait(1).to({x:464.05},0).wait(1).to({x:471.2},0).wait(1).to({x:478.35},0).wait(1).to({x:485.5},0).wait(1).to({x:492.65,y:714.65},0).wait(1).to({x:499.8},0).wait(1).to({x:506.95},0).wait(1).to({x:514.15},0).wait(1).to({x:521.3},0).wait(1).to({x:528.45,y:714.7},0).wait(1).to({x:535.6},0).wait(1).to({x:542.75},0).wait(1).to({x:549.9},0).wait(1).to({x:557.1},0).wait(1).to({x:564.25,y:714.75},0).wait(1).to({x:571.4},0).wait(1).to({x:578.6},0).wait(1).to({x:585.75},0).wait(1).to({x:592.9},0).wait(1).to({x:600.1},0).wait(1).to({x:607.25,y:714.8},0).wait(1).to({x:614.4},0).wait(1).to({x:621.6},0).wait(1).to({x:628.75},0).wait(1).to({x:635.95},0).wait(1).to({x:643.1,y:714.85},0).wait(1).to({x:650.3},0).wait(1).to({x:657.45},0).wait(1).to({x:664.65},0).wait(1).to({x:671.8},0).wait(1).to({x:679,y:714.9},0).wait(1).to({x:686.15},0).wait(1).to({x:693.35},0).wait(1).to({x:700.55},0).wait(1).to({x:707.7},0).wait(1).to({x:714.9,y:714.95},0).wait(1).to({x:722.1},0).wait(1).to({x:729.25},0).wait(1).to({x:736.45},0).wait(1).to({x:743.65},0).wait(1).to({x:750.85},0).wait(1).to({x:758,y:715},0).wait(1).to({x:765.2},0).wait(1).to({x:772.4},0).wait(1).to({x:779.6},0).wait(1).to({x:786.8},0).wait(1).to({x:794,y:715.05},0).wait(1).to({x:801.15},0).wait(1).to({x:808.35},0).wait(1).to({x:815.55},0).wait(1).to({x:822.75},0).wait(1).to({x:829.95,y:715.1},0).wait(1).to({x:837.15},0).wait(1).to({x:844.35},0).wait(1).to({x:851.55},0).wait(1).to({x:858.75},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).to({_off:true},1).wait(3));
	...
	// Layer 3
	this.instance_3 = new lib._3287();
	this.instance_3.setTransform(1288.4,-49,1.3214,1.2504,0,0,180);

	this.instance_4 = new lib.Bitmap18();
	this.instance_4.setTransform(540,964);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3}]}).wait(165));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-60.2,52.6,1405,1326.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1760736499616", id:"index_atlas_1"},
		{src:"sounds/checkpoint.mp3?1760736499920", id:"checkpoint"},
		{src:"sounds/click.mp3?1760736499920", id:"click"},
		{src:"sounds/click2.mp3?1760736499920", id:"click2"},
		{src:"sounds/CORNETAPERDIO.mp3?1760736499920", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1760736499920", id:"CORNETAUNAVEZ"},
		{src:"sounds/moneda2.mp3?1760736499920", id:"moneda2"},
		{src:"sounds/sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA.mp3?1760736499920", id:"sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1760736499920", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1760736499920", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1760736499920", id:"an.Video"}
	],
	preloads: []
};
