...
lib.ssMetadata = [
		{name:"Adivina el cantantante_atlas_1", frames: [[0,804,1280,720],[0,1526,1552,249],[1470,1331,82,82],[1282,1370,164,40],[1470,1261,206,68],[1282,804,537,200],[1282,1149,407,58],[1282,1006,523,141],[0,0,1399,802],[1282,1209,470,50],[1282,1261,186,107]]}
];
...
(lib.backgroundjpgcopy2 = function() {
	this.initialize(ss["Adivina el cantantante_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,19.75,0.6504,0.6504,-3.244);
...
}).prototype = getMCSymbolPrototype(lib.Symbol23, new cjs.Rectangle(-22.8,-98.3,45.6,196.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol22, new cjs.Rectangle(-588.1,-249.3,1176.3000000000002,498.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol21, new cjs.Rectangle(-82,-38.5,164.1,77), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-0.171,-4.1593);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(-0.171,-4.1593);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa.setTransform(0.004,-55.5,1.2463,1.2463);

	this.timeline.addTween(cjs.Tween.get(this.etiketa).wait(1));

	// Layer 2
	this.instance = new lib.logojpgcopy2();
	this.instance.setTransform(-110,-71,1.183,1.3289);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(324.6,266.35,1.3301,1.3301,-2.775,0,0,0.2,-0.2);

	this.instance_1 = new lib.Symbol23();
	this.instance_1.setTransform(500.8,-58.15,2.1099,2.1099,0,0,0,-0.1,-0.1);

	this.instance_2 = new lib.Symbol23();
	this.instance_2.setTransform(-573.75,-58.15,2.1099,2.1099,0,0,0,-0.1,-0.1);

	this.instance_3 = new lib.Symbol21();
	this.instance_3.setTransform(-391.5,263.35,1.3301,1.3301,1.1911,0,0,0.2,-0.2);

	this.instance_4 = new lib.Bitmap1();
	this.instance_4.setTransform(-776,218,1,0.3777);
...
p.nominalBounds = new cjs.Rectangle(-776,-265.3,1552,588.4000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(362.95,292.2,0.738,0.738,0,0,0,178,74.8);
	var instanceFilter_1 = new cjs.ColorFilter(0,0,0,1,153,0,0,0);
	this.instance.filters = [instanceFilter_1];
	this.instance.cache(-2,-2,360,154);

	this.instance_1 = new lib.Symbol34();
	this.instance_1.setTransform(-382.95,292.2,0.738,0.738,0,0,0,178,74.8);
	var instance_1Filter_2 = new cjs.ColorFilter(0,0,0,1,153,0,0,0);
	...
	this.instance_3.setTransform(-776,237,1,0.4358);
...
p.nominalBounds = new cjs.Rectangle(-776,-294.2,1552,641.5999999999999);
...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag4BWQAAgHACgHQAFgMAJgLQAKgLASgPQAbgXAKgNQAKgNAAgMQAAgNgJgIQgJgJgPAAQgOAAgJAJQgJAJAAARIgWgDQACgYAPgMQAOgNAYAAQAZAAAOANQAOAOAAAUQAAALgEAKQgEAKgKAKQgKALgWATQgSAQgGAGQgFAFgEAGIBUAAIAAAUg");
	this.shape.setTransform(604.1708,-323.625);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgJA+Igvh7IAXAAIAaBJIAHAZIAIgXIAbhLIAWAAIgvB7g");
	this.shape_1.setTransform(591.75,-321.225);
	...
	this.mipass.setTransform(-1030.55,-248.4);
	...
	this.passserv.setTransform(-1030.55,-315.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.mipassxx},{t:this.cbt7},{t:this.cbt8},{t:this.cbt9},{t:this.cbt4},{t:this.cbt5},{t:this.cbt6},{t:this.cbt1},{t:this.cbt2},{t:this.cbt3},{t:this.cbt0},{t:this.listo},{t:this.borrar},{t:this.passserv},{t:this.mipass},{t:this.instance_1},{t:this.instance},{t:this.shape_1},{t:this.shape}]}).to({state:[]},1).wait(3));
...
p.nominalBounds = new cjs.Rectangle(-1254.3,-401,1954.3,802);
...
p.nominalBounds = new cjs.Rectangle(-1429.8,-545.5,1723.1,651.5);
...
p.nominalBounds = new cjs.Rectangle(-310.2,-590.4,1698.5,702.1999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-382.65,-676.4,1,1,0,0,0,57.6,42);
...
p.nominalBounds = new cjs.Rectangle(-380.4,-813.5,1489.1999999999998,1519.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(instanceFilter_1).wait(50));
...
// stage content:
(lib.Adivinaelcantantante = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(1256.85,629.25);

	this.instance_2 = new lib.Symbol14();
	this.instance_2.setTransform(122.7,629.25);

	this.btfull = new lib.Symbol5();
	this.btfull.name = "btfull";
	this.btfull.setTransform(1231.1,46.4,0.6005,0.6005,0,0,0,49.2,42.7);

	this.reini = new lib.Symbol4();
	this.reini.name = "reini";
	this.reini.setTransform(43.25,42.75,0.578,0.578);

	this.bt10 = new lib.Symbol12();
	this.bt10.name = "bt10";
	this.bt10.setTransform(1112.6,434,1,1,0,0,0,-0.2,0);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(873.8,434,1,1,0,0,0,-0.2,0);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(635.05,434,1,1,0,0,0,-0.2,0);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(396.25,434,1,1,0,0,0,-0.2,0);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(157.9,434,1,1,0,0,0,-0.2,0);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(1112.6,250.2,1,1,0,0,0,-0.2,0);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(873.8,250.2,1,1,0,0,0,-0.2,0);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(635.05,250.2,1,1,0,0,0,-0.2,0);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(396.25,250.2,1,1,0,0,0,-0.2,0);

	this.bt1 = new lib.Symbol12();
	this.bt1.name = "bt1";
	this.bt1.setTransform(157.9,250.2,1,1,0,0,0,-0.2,0);
	...
	this.fsbtn.addEventListener("tick", AdobeAn.handleFilterCache);
...
p.nominalBounds = new cjs.Rectangle(30.5,-231.8,1314.3,1143.9);
// library properties:
lib.properties = {
	id: 'B0FC0294ED1C4D488924224D9514AFE0',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Adivina el cantantante_atlas_1.png?1727723773454", id:"Adivina el cantantante_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1727723773563", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1727723773563", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1727723773563", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1727723773563", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1727723773563", id:"an.Video"}
	],
	preloads: []
};
...
an.compositions['B0FC0294ED1C4D488924224D9514AFE0'] = {
